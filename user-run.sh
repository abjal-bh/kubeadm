...
ssh -o StrictHostKeyChecking=no -i /c/Users/abjal/Downloads/abs.pem ec2-user@$a sudo yum install  -y dos2unix;dos2unix installation.sh init.sh ip.txt;sudo sh init.sh
...
ssh -o StrictHostKeyChecking=no -i /c/Users/abjal/Downloads/abs.pem ec2-user@$b sudo yum install  -y dos2unix;dos2unix installation.sh init.sh ip.txt;sudo sh init.sh
...
ssh -o StrictHostKeyChecking=no -i /c/Users/abjal/Downloads/abs.pem ec2-user@$c sudo yum install  -y dos2unix;dos2unix installation.sh init.sh  ip.txt;sudo sh init.sh
